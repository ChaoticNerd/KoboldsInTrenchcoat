...
enum states {FORWARD1, FORWARD2, SLIGHT_R1, SLIGHT_R2, SLIGHT_R3, RIGHT1, RIGHT2, RIGHT3, 
...
State_t linefollower_fsm[NUM_STATES]={
	...
	{	HALT,				DELAY_LOST,	{ LOST, 			LOST, 			LOST, 			LOST, 			LOST, 			LOST, 			LOST, 			LOST, 			LOST, 			LOST, 			LOST, 			LOST, 			LOST, 			LOST, 			LOST, 			LOST			}},
