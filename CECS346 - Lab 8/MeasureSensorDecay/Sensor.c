...
void Sensor_Init(void){
  ...
  GPIO_PORTE_DIR_R   |= CONTRL_EVEN_MASK|SENSOR0_DIGITAL_MASK;  // set sensor CTRL even and sensor digital read back as outputs
	GPIO_PORTE_DIR_R   &= ~SENSOR0_MASK; // Set PE0 as input
